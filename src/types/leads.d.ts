export type LeadData = {
  ...
  groupKey: string;
  /**
   * Key value pairs that store additional information about this lead. First and last name required. Other eligable keys are based on Lead forms created. Use the /leads/form-template to view field names
   * @deprecated use `fields` instead
   */

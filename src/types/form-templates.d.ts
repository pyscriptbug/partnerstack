...
type Field = Exclude<
  Partnerstack.StandardObject,
  'apiName' | 'externalType' | 'fieldKey' | 'value'
> & {
  ...
  mapsTo: string;
  /**Boolean that limits values of field that can be edited. If True, this field may not be archived and type as well as required cannot be edited. */
  protected: boolean;
};
